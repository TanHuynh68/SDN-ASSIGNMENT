...
//put -> post for assignment 1
router.route(API_ROUTE.EDIT_WATCH).post(jwtMiddleware.authenticateToken, jwtMiddleware.isAdmin, validateWatch, watchController.editWatch)
router.route(API_ROUTE.DELETE_WATCH).post(jwtMiddleware.authenticateToken, jwtMiddleware.isAdmin, watchController.deleteWatch)
router.route(API_ROUTE.RESTORE_WATCH).post(jwtMiddleware.authenticateToken, jwtMiddleware.isAdmin, watchController.restoreWatch)
